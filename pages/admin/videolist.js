    ...
    return (
        ...
        >
            ...
            <div className="card bg2  p-2">
                <img src={rh.ImUrl + data.BNR} className="img-fluid rounded-top-1" height={250}
                     style={{maxHeight: "250px"}} alt=""/>
                    ...
                    <div className="d-flex justify-content-between align-items-center w-100 text-white "
                        ...
                        <div className="h4">
                            ...
                            <div className="form-switch d-flex align-items-center ">
                                <input className="form-check-input me-3 mb-2" type="checkbox" defaultChecked={data.paid}
                                       onChange={uu => {
...
const  [getf,setf]=useState([]);
    ...
    function loaddataUc(s="u") {

        axios.get("/api/categories").then(value => {


            setf(value.data.data);
    ...
    return <DndProvider backend={HTML5Backend}>
        ...
        <Sidex>
                        ...
                        {ads.map((itm, inxs) => {
                            ...
                            return <div key={inxs} className="col-lg-4 col-md-6 col-12 mt-2 ">
                                ...
                                <div className="cbody shadow-sm position-relative rounded-3 "
                                    ...
                                    <div
                                        className="bg-black opacity-75 rounded-bottom-3  position-absolute bottom-0  justify-content-between d-flex align-items-center px-2 w-100"
                                        style={{height: "70px"}}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-4">
                            <select className="form-control">
                                ...
                                {getf.map((value, index) => { return <option value={value.name}>{value.name}</option>})}
                        ...
                        {datax.map((itm, inxs) => {
                            ...
                            return <div key={inxs}
                                        className="col-lg-2 col-md-6 col-12 mt-2 shadow-sm ">

                                <div className="card bg-white bg2 ">
                                    <img src={rh.ImUrl + itm.BNR} className="img-fluid rounded-top-1"
                                         style={{maxHeight: "250px", cursor: "pointer"}} alt=""/>
                            ...
                            <div className=" ">
                                <div className="form-switch mb-1">
                                    <input className="form-check-input" type="checkbox" role="switch"
                                           ...
                                           defaultChecked={tixtle.chec !== null && tixtle.chec !== "null"}
                                           onChange={async o => {
            ...
            <div className="container-fluid">
                ...
                <div className="w-100 bg2 d-flex justify-content-between align-items-center px-2"
                     style={{height: "60px"}}>
                    <div className="">
                ...
                {Object.entries(vdata).reverse().map(([v, k], inx) => {
                    ...
                    return <div className="text-white row" key={inx}>
                        <div className="col-12 ">
                            <div className="d-flex display-6 justify-content-between  border-bottom border-4  ">
                                ...
                                <div className="">
                                    ...
                                    {v.split("|")[0] !== "SLIDER" && v.split("|")[0] !== "ADS" ?
                                        <div className="btn btn-primary mt-3" onClick={u => {
                        ...
                        {v.split("|")[0] !== "ADS" ? v.split("|")[0] !== "Categoryx" ? <> {k.map((i, o) => <div key={o}
                                ...
                                <div className="position-relative"><DraggableItem data={i} pos={o} cat={v} upitem={upitem}
                                                                                  delex={deletx} setpropsx={setpropx}/>
                                    <DroppableArea
                            ...
                            : k.map((lp, op) => {
                                ...
                                return <div key={op}
                                    ...
                                    <div className="card p-2 bg2">
                                        <img src={rh.ImUrl + lp.dp} className="img-fluid" height={250}
                                             style={{height: "250px", cursor: "pointer"}} alt="" onClick={u => {
                        ...
                        >
                            ...
                            <img src={rh.ImUrl + k.dp} className="w-100" height={k.height}
                                 style={{height: k.height, cursor: "pointer", objectFit: "fill"}} alt="" onClick={u => {
