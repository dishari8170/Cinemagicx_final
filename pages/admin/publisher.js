...
export default ()=>{
    ...
    function loaddataU(s="u") {
        ...
        axios.get("/api/publisher").then(value => {
    ...
    return<Sidex>
            ...
            <Modal show={isOpen} onHide={(i)=>{setIsOpen(false)}} fullscreen={false}  centered={true} onEscapeKeyDown={ip=>{ip.preventDefault()}}>
                <Modal.Header style={{backgroundColor:"#013571",color:"white"}}>
                    <div className="w-100 h3"><div className="text-center">Publisher</div>
                    </div>
                                ...
                                Swal.fire(
                                    {title:"Details are",html: '<div style="white-space: pre-wrap;">'+JSON.stringify(dat) +"</div>",icon:"info",
                                        ...
                                        preConfirm:async () => {
                                            ...
                                            return await axios.post(`/api/publisher${getc?._id?"?_id="+getc?._id:""}`, dat).then(r => {

                                                Swal.fire("Success", getc?._id?"Publisher Updted":"Publisher Created", "success").then(y=>{
                                ...
                                <td className=" ">
                                    <div className="d-flex justify-content-evenly align-items-center">
                                        ...
                                        <FaTrash onClick={y=>{
                                            ...
                                            axios.delete("/api/publisher?_id="+et._id).then(o=>{
