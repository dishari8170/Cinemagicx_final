...
export default () => {
    ...
    useEffect(() => {
        ...
        if (router.query._id) {
            ...
            axios.get("/api/more?direct=true&limit=10&on=_id&search=" + router.query._id).then(value => {
    ...
    const updateserver = async () => {
        ...
        const up = document.getElementById("loadingx")
        up.style.display = "flex";
        await axios.post("/api/more?_id=" + router.query._id, {data: JSON.stringify(vdata)})
        up.style.display = "none";
    }
